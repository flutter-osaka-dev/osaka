...
<img alt="Slack Logo" src="/slack.png" style="width: 100%;" />

[Slack Logos](https://brandfolder.com/slack/logos) よりロゴ画像を使わせていただいてます。

### Slack 利用における注意点

Slack 内の秩序を最大限守るため、全てのコミュニティ参加者には協力を申し上げます。

::: tip Slack チャンネル命名ルール

- `#general` 全体的なアナウンスの場
- `#mokumoku` Flutter Osaka のもくもく会で共有する場
- `#handson` Flutter Osaka のハンズオンで共有する場
  - 各ハンズオンに応じて `handson-XXX` を prefix に設定
- `#meetup` Flutter Osaka のイベントで共有する場
  - 各ミートアップに応じて `meetup-XXX` を prefix に設定
- `#events` Flutter Osaka 以外のイベントで共有する場
- `#group-XXX` `group-` を prefix に設定
  - Dart や Riverpod などそれぞれのテーマに応じてチャンネルを準備
- `#announcements` Flutter リリース関連
- `#i-made-this` 自分自身で作ったライブラリを紹介する場
- `#questions` 自由に質問する場
