...
※flutter(verChannel beta, 1.26.0-17.6.pre)でFlutter for Webの起動が確認できる方は【アプリ起動】の項目に飛んでください※
...
https://storage.googleapis.com/flutter_infra/releases/beta/windows/flutter_windows_1.26.0-17.6.pre-beta.zip

※ リンク切れなら[こちら](https://flutter.dev/docs/get-started/install)の指示に従ってSDKをダウンロードしてください
...
3-2-4. AndroidStudioの`configure` からsdk managerを起動し、SDK ToolsからHAXMにチェックを入れ `ok` を押下
...
https://storage.googleapis.com/flutter_infra/releases/beta/macos/flutter_macos_1.26.0-17.6.pre-beta.zip
